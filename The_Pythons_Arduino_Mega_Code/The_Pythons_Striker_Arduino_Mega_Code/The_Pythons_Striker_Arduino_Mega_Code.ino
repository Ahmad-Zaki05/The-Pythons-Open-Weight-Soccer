...
//#define Down_Right_Direction 8
//#define Upper_Left_Direction 4
//#define Upper_Right_Direction 6
//#define Down_Left_PWM 3
//#define Down_Right_PWM 9
//#define Upper_Left_PWM 5
//#define Upper_Right_PWM 7
...
// Striker (new motors)
#define ir_0 A11 ////right back //
#define ir_1 A8 ////right front
#define ir_2 A10 ////back right // 
#define ir_3 A7 ////back left
#define ir_4 A9 //// left back
#define ir_5 A6 //// left front//
#define ir_6 A1 ////front right// 
